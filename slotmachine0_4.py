...
def start_game():
  ...
  digital_fonts_hash = [
    {"method": slot_machine.get_bet, "pos": (298, 420)},
    {"method": slot_machine.get_current_cash, "pos": (160, 420)},
    {"method": slot_machine.get_current_jackpot, "pos": (410, 420)},
  ]
  digital_fonts = pygame.sprite.Group()

  current_message_digifont = DigitalFont(slot_machine.get_current_message, (140, 110), (0, 0, 0))
  ...
  spin_button = SlotMachineActionButton("spin_button.png" , slot_machine.spin, (545, 99))
  ...
  reel_positions = [(143, 152), (272, 152), (397, 152)]
  ...
  prev_bet_digifont = DigitalFont(prev_get_bet, (298, 420))
  prev_cash_digifont = DigitalFont(prev_get_current_cash, (160, 420))
  prev_jackpot_digifont = DigitalFont(prev_get_current_jackpot, (410, 420))
  prev_message_digifont = DigitalFont(prev_get_current_msg, (140, 110), (0, 0, 0))
